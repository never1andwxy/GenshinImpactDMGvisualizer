...
//bonusDMG
    ...
    enemyPhysicalresv =
        eneresbytype[enemytype]['physical'] - (zhonglieOn ? 20 : 0);
    ...
    enemyElectroresv =
        eneresbytype[enemytype]['electro'] - (zhonglieOn ? 20 : 0);
    ...
    enemyCryoresv = eneresbytype[enemytype]['cryo'] -
        (constellation1On ? 15 : 0) -
        (zhonglieOn ? 20 : 0);
    if (enemyCryoresv < 0)
    ...
    hit1dmgc = allatk *
        ...
        (1 + allCD / 100) *
        (1 +
            bonusPhysicalDMGpercent / 100 +
            bonusNormalATKDMGpercent / 100 +
            bonusDMGpercent / 100) *
        (100 + level) /
    ...
    frostflakebloomdmgc = allatk *
        ...
        (1 +
            bonusCryoDMGpercent / 100 +
            bloomBonusChargedATKDMGpercent / 100 +
            bonusDMGpercent / 100) *
        (100 + level) /
        ((1 - enemydefdebuff / 100) * (100 + enemylv) + 100 + level) *
        enemyCryores;
                                      ...
                                      children: [
                                        ...
                                        if (manualatkOn)
                                          buildStatRow(
                                              Colors.red[300],
                                              'Manual:ATK',
                                              (manualatk.toStringAsFixed(1))),
                                        if (manualatkpercentOn)
                                          buildStatRow(
                                              Colors.red[300],
                                              'Manual:ATK%($manualatkpercent)',
                                              ((basicatk *
                                                      manualatkpercent /
                                                      100)
                                                  .toStringAsFixed(1))),
                                        ...
                                        if (unreturningOn == true)
                                          buildstatbar(
                                              ...
                                              (basicatk *
                                                  ...
                                                  100)),
                                        if (dragonslayerOn)
                                          buildstatbar(Colors.grey,
                                              (basicatk * 48 / 100)),
                                        if (bennetqOn)
                                          buildstatbar(
                                              Colors.red,
                                              (bennetbasicatk *
                                                  bennetqlvtoratio[bennetqlv] /
                                                  100)),
                                        if (manualatkOn)
                                          buildstatbar(
                                              Colors.red[300], (manualatk)),
                                        if (manualatkpercentOn)
                                          buildstatbar(
                                              Colors.red[300],
                                              (basicatk *
                                ...
                                children: <Widget>[
                                  ...
                                  Wrap(spacing: 10, runSpacing: 10, children: <
                                    ...
                                    if (artifactsetAselect ==
                                      ...
                                      FilterChip(
                                        label: Text(
                                            '4 set: DMG Against Opponents Affected By Electro +35% '),
                                  ...
                                  Wrap(
                                      ...
                                      children: <Widget>[
                                        FilterChip(
                                          ...
                                          label: Text(
                                              'Zhongli(skill):Enemy All res - 20%'),
                                          selected: zhonglieOn,
                                          onSelected: (bool value) {
                                            setState(() {
                                              zhonglieOn = value;
                                        ...
                                        FilterChip(
                                          ...
                                          label: Text(
                                              'Thrilling Tales of Dragon Slayers(R5): ATK +48%'),
